...
- [ ] 2. Implement user profile data models and service
  - [ ] 2.1 Create User and Profile database models
  ...
  - [ ] 2.3 Implement ProfileService with CRUD operations
...
- [ ] 3. Implement opportunity data models and service
  - [ ] 3.1 Create Opportunity database model
  ...
  - [ ] 3.2 Implement OpportunityService with CRUD operations
